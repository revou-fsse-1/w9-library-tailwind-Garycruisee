...
function mobileMenuBtn() {
  let mobMenuBtn = document.getElementById("m-menu-button"),
    mobMenu = document.getElementById("m-menu");
  mobMenuBtn.children[1].classList.contains("block")
    ? (mobMenuBtn.children[1].classList.replace("block", "hidden"),
      mobMenuBtn.children[2].classList.replace("hidden", "block"),
      mobMenu.classList.replace("hidden", "block"))
    : (mobMenuBtn.children[1].classList.replace("hidden", "block"),
      mobMenuBtn.children[2].classList.replace("block", "hidden"),
      mobMenu.classList.replace("block", "hidden"));
}
